...
namespace AdvancedDatabaseAndORMAssignment1.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public AlbumsController(AdvancedDatabaseAndORMAssignment1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var album = await _context.Album.Include(a => a.Songs).ThenInclude(ca => ca.SongContributor).ThenInclude(ca => ca.Artist)
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMAssignment1Context.Album'  is null.");
            }
            var album = await _context.Album.FindAsync(id);
            if (album != null)
            {
